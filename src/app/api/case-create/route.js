...
export async function POST(req) {
  ...
  // Insert the new task into the "cases" table
  await db.run("INSERT INTO case_details(case_uuid, case_number, case_description, case_investigator_name, case_investigator_organization, case_status) VALUES (?, ?, ?, ?, ?, ?)", 
    [case_uuid, caseNumber, caseDescription, investigator, organization, 'Active']);
