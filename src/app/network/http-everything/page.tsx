      ...
      <div className="flex-grow p-8 ml-64">
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">Statistics For Http Everything</h1>
          </div>
        </header>
        <main>
          <div className='allTableDetailsHere'>
            {getCaseUuid && <HttpEverythingDrawing case_uuid={getCaseUuid} />}
          </div>
          <div className='allDrawingDetailsHere'>
            <HttpEverythingTableDetails case_uuid={getCaseUuid} />
          </div>
        </main>
      </div>
    </div>
