...
export default function HTTPRequestsTable(props) {
  ...
  useEffect(()=>{
      setIsLoading(true);
      fetch(`${endpoint}/get-http-requests?page=${page}&limit=${limit}&case_uuid=${getCaseUuid}`, {
        method: "GET",
        headers: {
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
              {getHTTPrequestsData?.map((item, index) => (
          ...
          { getHTTPrequestsData?.length === 0 &&(<div className="flex justify-center py-4">
